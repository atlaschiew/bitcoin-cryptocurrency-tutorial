...
$_HTML['title'] = 'Bitwasp P2SH';
$_HTML['meta']['keywords'] = "Bitwasp,P2SH,Pay To Script Hash,PHP";
include_once "../common.php";
include_once("html_header.php");
?>
<h2 class="mt-3">Bitwasp P2SH</h2>
<hr/>
...
<div class="tab-content">
	<div id="form1_tabitem1" class="tab-pane fade show active">
		<iframe id='iframe_p2sh_address' src="bitwasp_script_p2sh_address.php" width="100%" scrolling="no" frameborder="no"></iframe>
	</div>
	<div id="form1_tabitem2" class="tab-pane fade">
		<pre style='border-radius:none;'>
<?php echo htmlentities(file_get_contents("bitwasp_script_p2sh_address.php"));?>
		</pre> 		
	</div>
</div>
<hr/>
	...
	<div id="sample1_info" class="tab-pane fade show active">
		...
		<div class="tab-content">
			<div id="sample1_tabitem1" class="tab-pane fade show active">
				<iframe src="bitwasp_script_p2sh_simplemath.php" width="100%" scrolling="no" frameborder="no"></iframe>
			</div>
			
			<div id="sample1_tabitem2" class="tab-pane fade">
				<pre style='border-radius:none;'>
<?php echo htmlentities(file_get_contents("bitwasp_script_p2sh_simplemath.php"));?>
				</pre> 		
			</div>
		</div>		
	</div>
		...
		<div class="tab-content">
			<div id="sample4_tabitem1" class="tab-pane fade show active">
				<div class="col-sm-12">
					...
					<iframe src="bitwasp_script_p2sh_multisig.php" width="100%" scrolling="no" frameborder="no"></iframe>
...
<div class="tab-content">
	<div id="form2_tabitem1" class="tab-pane fade show active">
		<iframe src="bitwasp_script_p2sh_fund.php" width="100%" scrolling="no" frameborder="no"></iframe>
	</div>
	<div id="form2_tabitem2" class="tab-pane fade">
		<pre style='border-radius:none;'>
<?php echo htmlentities(file_get_contents("bitwasp_script_p2sh_fund.php"));?>
		</pre> 
	</div>
	
	<div id="form2_tabitem3" class="tab-pane fade">
		<iframe src="bitwasp_script_p2sh_spend.php" width="100%" scrolling="no" frameborder="no"></iframe>
	</div>
	<div id="form2_tabitem4" class="tab-pane fade">
		<pre style='border-radius:none;'>
<?php echo htmlentities(file_get_contents("bitwasp_script_p2sh_spend.php"));?>
		</pre> 
	</div>
</div>
<script>
