...
$_HTML['title'] = 'Bitcoin P2SH.LOCKTIME';
$_HTML['meta']['keywords'] = "Bitcoin,P2SH LOCKTIME,P2SH CheckLockTimeVerify,P2SH CheckSequenceVerify,PHP";
...
<div class="tab-content">
	<div id="form1_tabitem1" class="tab-pane fade show active">
		<iframe src="bitcoin_script_p2sh_cltv_address.php" width="100%" scrolling="no" frameborder="no"></iframe>
	</div>
	<div id="form1_tabitem2" class="tab-pane fade">
		<pre style='border-radius:none;'>
<?php echo htmlentities(file_get_contents("bitcoin_script_p2sh_cltv_address.php"));?>
		</pre> 		
	</div>
	
	<div id="form1_tabitem3" class="tab-pane fade">
		<iframe src="bitcoin_script_p2sh_csv_address.php" width="100%" scrolling="no" frameborder="no"></iframe>
	</div>
	<div id="form1_tabitem4" class="tab-pane fade">
		<pre style='border-radius:none;'>
<?php echo htmlentities(file_get_contents("bitcoin_script_p2sh_csv_address.php"));?>
		</pre> 		
	</div>
</div>
<hr/>
...
<div class="tab-content">
	<div id="form2_tabitem1" class="tab-pane fade show active">
		<iframe src="bitcoin_script_p2sh_cltv_fund.php" width="100%" scrolling="no" frameborder="no"></iframe>
	</div>
	<div id="form2_tabitem2" class="tab-pane fade">
		<pre style='border-radius:none;'>
<?php echo htmlentities(file_get_contents("bitcoin_script_p2sh_cltv_fund.php"));?>
		</pre> 
	</div>
	
	<div id="form2_tabitem3" class="tab-pane fade">
		<iframe src="bitcoin_script_p2sh_cltv_spend.php" width="100%" scrolling="no" frameborder="no"></iframe>
	</div>
	<div id="form2_tabitem4" class="tab-pane fade">
		<pre style='border-radius:none;'>
<?php echo htmlentities(file_get_contents("bitcoin_script_p2sh_cltv_spend.php"));?>
		</pre> 
	</div>
	
	<div id="form2_tabitem5" class="tab-pane fade">
		<iframe src="bitcoin_script_p2sh_csv_fund.php" width="100%" scrolling="no" frameborder="no"></iframe>
	</div>
	<div id="form2_tabitem6" class="tab-pane fade">
		<pre style='border-radius:none;'>
<?php echo htmlentities(file_get_contents("bitcoin_script_p2sh_csv_fund.php"));?>
		</pre> 
	</div>
	
	<div id="form2_tabitem7" class="tab-pane fade">
		<iframe src="bitcoin_script_p2sh_csv_spend.php" width="100%" scrolling="no" frameborder="no"></iframe>
	</div>
	<div id="form2_tabitem8" class="tab-pane fade">
		<pre style='border-radius:none;'>
<?php echo htmlentities(file_get_contents("bitcoin_script_p2sh_csv_spend.php"));?>
		</pre> 
	</div>
</div>
<?php
