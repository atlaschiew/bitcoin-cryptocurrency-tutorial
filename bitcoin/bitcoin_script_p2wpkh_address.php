	...
	?>
		<div class="table-responsive">
			<table border=0 class='table'>
				<tr style='background-color:#f0f0f0'><td>Bech32 Address</td><td><?php echo $p2wpkh->getAddress()?></td></tr>
				...
				<tr style='background-color:#f0f0f0'><td>ScriptPubKey Hex </td><td><?php echo $p2wpkhWP->getScript()->getHex()?></td></tr>
				<tr style='background-color:#f0f0f0'><td>ScriptPubKey Asm</td>
					<td>
						<?php 
						$opcodes = $p2wpkhWP->getScript()->getOpcodes();
						
						foreach( $p2wpkhWP->getScript()->getScriptParser()->decode() as $operation ) {
