...
$_HTML['title'] = 'Bitcoin P2SH.P2WPKH';
$_HTML['meta']['keywords'] = "Bitcoin,Pay To Witness Public Key Hash Wrapped In P2SH,P2SH P2WPKH,PHP";
...
?>
<h2 class="mt-3">Bitcoin P2SH.P2WPKH</h2>
<hr/>
...
<div class='vertical-line-green'>
	<h6 class="mt-3">Script Pair of P2SH.P2WPKH</h6>
	<table>
		<tr>
			<td>ScriptPubKey</td><td>: OP_HASH160 14<?php echo htmlentities("<20 Bytes RedeemScriptHash>")?> OP_EQUAL</td>
		</tr>
		<tr>
			<td>ScriptSig</td><td>: <?php echo htmlentities("<00 14<20 Bytes PublicKeyHash>>")?></td>
		</tr>
		<tr>
			<td>Redeem Script</td><td>: <?php echo htmlentities("00 14<20 Bytes PublicKeyHash>")?></td>
		</tr>
		<tr>
...
<hr/>
<h3 class="mt-3" id='hashtag3'>P2SH.P2WPKH Address</h3>
...
<div class="tab-content">
	<div id="form1_tabitem1" class="tab-pane fade show active">
		<iframe src="bitcoin_script_p2sh_p2wpkh_address.php" width="100%" scrolling="no" frameborder="no"></iframe>
	</div>
	<div id="form1_tabitem2" class="tab-pane fade">
		<pre style='border-radius:none;'>
<?php echo htmlentities(file_get_contents("bitcoin_script_p2sh_p2wpkh_address.php"));?>
		</pre> 		
	</div>
</div>
<hr/>
...
<h3 class="mt-3" id='hashtag2'>Fund & Spend P2SH.P2WPKH</h3>
<ul class="nav nav-tabs">
...
<div class="tab-content">
	<div id="form2_tabitem1" class="tab-pane fade show active">
		<iframe src="bitcoin_script_p2sh_p2wpkh_fund.php" width="100%" scrolling="no" frameborder="no"></iframe>
	</div>
	<div id="form2_tabitem2" class="tab-pane fade">
		<pre style='border-radius:none;'>
<?php echo htmlentities(file_get_contents("bitcoin_script_p2sh_p2wpkh_fund.php"));?>
		</pre> 
	</div>
	
	<div id="form2_tabitem3" class="tab-pane fade">
		<iframe src="bitcoin_script_p2sh_p2wpkh_spend.php" width="100%" scrolling="no" frameborder="no"></iframe>
	</div>
	<div id="form2_tabitem4" class="tab-pane fade">
		<pre style='border-radius:none;'>
<?php echo htmlentities(file_get_contents("bitcoin_script_p2sh_p2wpkh_spend.php"));?>
		</pre> 
	</div>
</div>
<?php
