...
$_HTML['title'] = 'Bitcoin Verify Script';
$_HTML['meta']['keywords'] = "Bitcoin,Verify Script,Bitcoin Tool,PHP";

include_once "../common.php";
include_once("html_header.php");

?>
<h2 class="mt-3">Bitcoin Verify Script</h2>
<hr/>
...
<div class="tab-content">
	<div id="form1_tabitem1" class="tab-pane fade show active">
		<iframe id="iframe_verify_form" src="bitcoin_tool_verify_script_form.php" width="100%" scrolling="no" frameborder="no"></iframe>
	</div>
	<div id="form1_tabitem2" class="tab-pane fade">
		<pre style='border-radius:none;'><?php
			echo htmlentities(file_get_contents("bitcoin_tool_verify_script_form.php"));
		?>
		</pre> 		
	</div>
</div>
...
<div class="tab-content">
	<div id="form2_tabitem1" class="tab-pane fade show active">
		<iframe src="bitcoin_tool_verify_script_math.php" width="100%" scrolling="no" frameborder="no"></iframe>
	</div>
	<div id="form2_tabitem2" class="tab-pane fade">
		<pre style='border-radius:none;'><?php
			echo htmlentities(file_get_contents("bitcoin_tool_verify_script_math.php"));
		?>
		</pre> 		
	</div>
</div>
...
<div class="tab-content">
	<div id="form3_tabitem1" class="tab-pane fade show active">
		<iframe src="bitcoin_tool_verify_script_hashlock.php" width="100%" scrolling="no" frameborder="no"></iframe>
	</div>
	<div id="form3_tabitem2" class="tab-pane fade">
		<pre style='border-radius:none;'><?php
			echo htmlentities(file_get_contents("bitcoin_tool_verify_script_hashlock.php"));
		?>
		</pre> 		
	</div>
</div>
