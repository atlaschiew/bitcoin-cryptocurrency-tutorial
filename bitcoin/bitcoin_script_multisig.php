...
$_HTML['title'] = 'Bitcoin MULTISIG';
$_HTML['meta']['keywords'] = "Bitcoin,MULTISIG,Pay To Multi Signature,Pay To Multisig wrapped in P2SH,P2MS,P2SH Multisig,PHP";
...
<h2 class="mt-3">Bitcoin MULTISIG</h2>
<hr/>
...
<div class="tab-content">
	<div id="form1_tabitem1" class="tab-pane fade show active">
		<iframe src="bitcoin_script_multisig_address.php" width="100%" scrolling="no" frameborder="no"></iframe>
	</div>
	<div id="form1_tabitem2" class="tab-pane fade">
		<pre style='border-radius:none;'>
<?php echo htmlentities(file_get_contents("bitcoin_script_multisig_address.php"));?>
		</pre> 		
	</div>
</div>
<hr/>
...
<div class="tab-content">
	<div id="form2_tabitem1" class="tab-pane fade show active">
		<iframe src="bitcoin_script_multisig_fund.php" width="100%" scrolling="no" frameborder="no"></iframe>
	</div>
	<div id="form2_tabitem2" class="tab-pane fade">
		<pre style='border-radius:none;'>
<?php echo htmlentities(file_get_contents("bitcoin_script_multisig_fund.php"));?>
		</pre> 
	</div>
	
	<div id="form2_tabitem3" class="tab-pane fade">
		<iframe src="bitcoin_script_multisig_spend.php" width="100%" scrolling="no" frameborder="no"></iframe>
	</div>
