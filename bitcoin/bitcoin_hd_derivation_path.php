...
$_HTML['title'] = 'Bitcoin Derivation Path';
$_HTML['meta']['keywords'] = "Bitcoin Derivation Path,PHP Derivation Path,PHP BIP44,BIP49,BIP84";

include_once "../common.php";
include_once("html_header.php");

?>
<h2 class="mt-3">Bitcoin Derivation Path</h2>
<hr/>
...
<div class="tab-content">
	<div id="form1_tabitem1" class="tab-pane fade show active">
		<iframe src="bitcoin_hd_extended_xpriv_form.php" width="100%" scrolling="no" frameborder="no"></iframe>
	</div>
	<div id="form1_tabitem2" class="tab-pane fade">
		<pre style='border-radius:none;'><?php
			echo htmlentities(file_get_contents("bitcoin_hd_extended_xpriv_form.php"));
		?>
		</pre> 		
	</div>
</div>
...
<div class="tab-content">
	<div id="form1_tabitem1" class="tab-pane fade show active">
		<iframe src="bitcoin_hd_xpub_address_array_form.php" width="100%" scrolling="no" frameborder="no"></iframe>
	</div>
	<div id="form1_tabitem2" class="tab-pane fade">
		<pre style='border-radius:none;'><?php
			echo htmlentities(file_get_contents("bitcoin_hd_xpub_address_array_form.php"));
		?>
		</pre> 		
	</div>
</div>
