...
$_HTML['title'] = 'Bitcoin Tx Hex';
$_HTML['meta']['keywords'] = "Bitcoin,Blockcypher,Electrum,Tx Hex,Tx Serialization,PHP";

include_once "../common.php";
include_once("html_header.php");

?>
<h2 class="mt-3">Bitcoin Tx Hex</h2>
<hr/>
...
<div class="tab-content">
	<div id="form1_tabitem1" class="tab-pane fade show active">
		<iframe src="bitcoin_tool_txhex_form.php" width="100%" scrolling="no" frameborder="no"></iframe>
	</div>
	<div id="form1_tabitem2" class="tab-pane fade">
		<pre style='border-radius:none;'><?php
			echo htmlentities(file_get_contents("bitcoin_tool_txhex_form.php"));
		?>
		</pre> 		
	</div>
</div>
...
<div class="tab-content">
	<div id="form2_tabitem1" class="tab-pane fade show active">
		<iframe src="bitcoin_tool_txhex_form_electrum.php" width="100%" scrolling="no" frameborder="no"></iframe>
	</div>
	<div id="form2_tabitem2" class="tab-pane fade">
		<pre style='border-radius:none;'><?php
			echo htmlentities(safe_electrum_source(file_get_contents("bitcoin_tool_txhex_form_electrum.php")));
		?>
		</pre> 		
	</div>
</div>
