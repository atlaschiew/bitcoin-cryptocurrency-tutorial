...
$_HTML['title'] = 'Bitcoin Mnemonic Code (BIP39)';
$_HTML['meta']['keywords'] = "Bitcoin,Bitcoin Mnemonic Code,Bitcoin BIP39,Bitcoin BIP32,PHP Mnemonic Code,PHP BIP39,PHP BIP32";

include_once "../common.php";
include_once("html_header.php");

?>
<h2 class="mt-3">Bitcoin Mnemonic Code (BIP39)</h2>
<hr/>
...
<div class="tab-content">
	<div id="form1_tabitem1" class="tab-pane fade show active">
		<iframe src="bitcoin_hd_mnemonic_code_form.php" width="100%" scrolling="no" frameborder="no"></iframe>
	</div>
	<div id="form1_tabitem2" class="tab-pane fade">
		<pre style='border-radius:none;'><?php
			echo htmlentities(file_get_contents("bitcoin_hd_mnemonic_code_form.php"));
		?>
		</pre> 		
	</div>
</div>
