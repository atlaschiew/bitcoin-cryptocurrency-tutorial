...
$_HTML['title'] = 'Blockchain Median Time Past';
$_HTML['meta']['keywords'] = "Blockchain,Median Time Past,MTP,PHP";

include_once "../common.php";
include_once("html_header.php");

?>
<h2 class="mt-3">Blockchain Median Time Past</h2>
<hr/>
...
<div class="tab-content">
	<div id="form1_tabitem1" class="tab-pane fade show active">
		<iframe src="blockchain_tool_mtp_form.php" width="100%" scrolling="no" frameborder="no"></iframe>
	</div>
	<div id="form1_tabitem2" class="tab-pane fade">
		<pre style='border-radius:none;'><?php
			echo htmlentities(file_get_contents("blockchain_tool_mtp_form.php"));
		?>
		</pre> 		
	</div>
</div>
