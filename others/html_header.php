...
<body>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light " id="sidebar-wrapper">
		...
		<div class="list-group-header">Other Menu</div>
		<div class="list-group list-group-flush">
			<a href="qr_code.php" class="list-group-item list-group-item-action bg-light">QR Code Generator</a>
    ...
    <div id="page-content-wrapper" >
      ...
      <nav class="navbar navbar-expand-lg navbar-light border-bottom" style='background-color:#5F5F5F;'>
        <button class="btn btn-success" id="menu-toggle">Others Menu</button>
